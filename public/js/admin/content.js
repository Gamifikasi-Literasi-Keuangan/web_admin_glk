...
function renderDifficulty(level) {
    if (level === 1) return '<span class="bg-green-100 text-green-700 text-xs px-2 py-1 rounded-full border border-green-200 font-semibold">Easy</span>';
    if (level === 2) return '<span class="bg-yellow-100 text-yellow-700 text-xs px-2 py-1 rounded-full border border-yellow-200 font-semibold">Medium</span>';
    return '<span class="bg-red-100 text-red-700 text-xs px-2 py-1 rounded-full border border-red-200 font-semibold">Hard</span>';
}
