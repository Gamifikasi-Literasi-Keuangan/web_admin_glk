...
async function renderPlayerDetail(playerId) {
    ...
    : []; 
        ...
        const skillHtml = Object.entries(skill).map(([k, v]) => {
            let skillColor = 'bg-red-500';
            let skillIcon = 'fas fa-times-circle';
            ...
            return `
                <div class="bg-zinc-700/50 border border-zinc-600 rounded-lg p-4 hover:bg-zinc-700 transition-all">
                    <div class="flex justify-between items-center">
                        <div class="flex items-center gap-3">
                            ...
                            <span class="text-zinc-200 font-medium font-['Poppins']">${k}</span>
                        </div>
                        <div class="${skillColor} px-3 py-1 rounded-full">
                            <span class="text-white text-xs font-bold uppercase font-['Poppins']">${v}</span>
                        </div>
                    </div>
                </div>
            `;
