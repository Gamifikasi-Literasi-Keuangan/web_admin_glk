...
@section('content')
    <div class="mb-8">
        ...
        <div class="bg-gradient-to-r from-zinc-50 to-zinc-100 border border-zinc-200 rounded-lg p-2 shadow-sm">
            <nav class="flex space-x-2">
                ...
                <button onclick="switchTab('scoring')" id="tab-scoring"
                    ...
                    <div class="bg-zinc-100 p-1.5 rounded-full mr-3">
                        <i class="fa-solid fa-calculator text-zinc-500 text-sm"></i>
                    </div>
                    <span>Config Skor</span>
                </button>
    ...
    <div id="tile-modal"
        class="fixed inset-0 bg-zinc-900 bg-opacity-50 backdrop-blur-sm hidden items-center justify-center z-50 flex p-4">
        <div
            class="bg-white border border-zinc-200 rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] overflow-auto relative">
            <div class="sticky top-0 bg-white border-b border-zinc-200 p-4 flex items-center justify-between rounded-t-lg">
                ...
                <button onclick="closeModal()"
                    class="bg-zinc-100 hover:bg-zinc-200 text-zinc-600 hover:text-zinc-800 p-2 rounded-lg transition-colors">
